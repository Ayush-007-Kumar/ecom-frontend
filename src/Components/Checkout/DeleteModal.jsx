...
function DeleteModal({ open, setOpen, title, onDeleteHandler, loader }) {
  return (
    <Dialog open={open} onClose={setOpen} className="relative z-50">
      <DialogBackdrop
        transition
        className="fixed inset-0 bg-gray-500 opacity-50 transition-opacity data-[closed]:opacity-50 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in"
      />
