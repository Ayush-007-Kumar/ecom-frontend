      ...
      <Dialog open={open} as="div" className="relative z-10" onClose={close}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all md:max-w-[30%] md:min-w-[30%] "
            >
              {image && (
              ...
              <div className="px-6 pb-4 flex justify-end gap-4">
                <button
                  ...
                  type="button"
                  className="px-4 py-2 text-sm font-semibold text-slate-700 border border-slate-700 hover:cursor-pointer hover:bg-green-500 transition-colors duration-150 hover:text-white rounded-md"
                >
                  Close
                </button>
              </div>
