    ...
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      <div className="flex flex-col items-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
          <MdShoppingCart size={30} className="text-gray-700" /> Your Cart
        </h1>
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
        ...
        <div className="flex text-sm gap-1 flex-col">
          ...
          <Link className="w-full flex justify-end" to="/checkout">
            <button
              onClick={() => {}}
              className="font-semibold w-[300px] py-2 px-4 rounded-sm bg-blue-600 text-gray-200 flex items-center justify-center gap-2 hover:text-white transition duration-500"
            >
